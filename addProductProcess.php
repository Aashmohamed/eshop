...
if($category=="0"){
    ...
    if($modelHasBrand->num_rows == 0){
        ...
        (`category`,`model_has_brand_id`,`colour_id`,`price`,`description`,`title`,`qty`,
        `condition_id`,`status_id`,`user_email`,`datetime_added`,
        `delivery_fee_colombo`,`delivery_fee_other`) VALUES('".$category."','".$modelHasBrand."',
        '".$color."','".$price."','".$description."','".$title."','".$qty."','".$condition."',
        '".$status."','".$usermail."','".$date."','".$dwc."','".$doc."')");
