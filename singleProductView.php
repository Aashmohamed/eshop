...
if (isset($_GET["id"])) {
    ...
    $productrs = Database::search("SELECT product.id,product.category,product.model_has_brand_id,product.title,
    product.colour_id,product.price,product.qty,product.description,product.condition_id,product.status_id,
    product.user_email,product.datetime_added,product.delivery_fee_colombo,product.delivery_fee_other,model.name AS `mname`,
    brand.name AS `bname` FROM product INNER JOIN model_has_brand ON model_has_brand.id=product.model_has_brand_id 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <label class="text-success fs-6 fw-bold">Seller's Name : <?php echo $userrd["fname"] . " " . $userrd["lname"]; ?></label><br />
                                        ...
                                        <div class="col-12 col-lg-3 bg-white border border-1 border-danger rounded">
                                            <div class="row">
                                                <div class="col-12 text-center">
                                                    <span class="text-center fs-5 fw-bold"><?php echo $user_data["fname"]; ?></span>
                                                    <br />
