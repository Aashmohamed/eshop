...
$message_rs = Database::search("SELECT * FROM `message` WHERE `from`='" . $sender_email . "' OR `to`='" . $recever_email . "'");
...
?>
        <!-- receiver's message -->
        <div class="mb-3 w-50">
            <img src="resources/user.svg" width="60px" class="rounded-circle mb-1">
            <div>
                <div class="bg-light rounded py-2 px-3 mb-2">
                    <p class="mb-0 text-dark"><?php echo $message_data["content"]; ?></p>
                </div>
                <p class="small text-black-50 text-end">01:43 | 10.05.2022</p>
